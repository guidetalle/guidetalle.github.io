const sublinks = [
    {
      page: 'CV/Resume',
      links: [
        { label: 'CV/Resume intéractif', icon: 'fas fa-address-card', url: '/welcome/resume.html' },
    ...
    },
    {
      page: 'Portfolio',
      links: [
        { label : 'Présentation de mes projets', icon : 'fas fa-book', url : '/welcome/portfolio.html'},
