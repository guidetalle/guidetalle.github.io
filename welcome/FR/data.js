const sublinks = [
    {
      page: 'CV/Resume',
      links: [
        { label: 'CV/Resume intéractif', icon: 'fas fa-address-card', url: '/welcome/FR/resume.html' },
    ...
    },
    {
      page: 'Portfolio',
      links: [
        { label : 'Présentation de mes projets', icon : 'fas fa-book', url : '/welcome/FR/portfolio.html'},
